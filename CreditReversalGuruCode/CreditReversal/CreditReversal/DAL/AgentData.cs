...
namespace CreditReversal.DAL
{
    public class AgentData
    {
        ...
        public int checkAutoChallengesExists(string round, string clientid, string mode)
        {
            int res = 0; string sql = "";
            try
            {
