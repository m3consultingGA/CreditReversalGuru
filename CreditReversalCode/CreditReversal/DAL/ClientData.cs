        ...
        public long CreateClient(ClientModel ClientModel)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    sql += "SocialSecCard=@SocialSecCard,ProofOfCard=@ProofOfCard,Status=@Status,CreatedBy=@CreatedBy,CreatedDate=@CreatedDate,isPrevItemInLastYear=@isPrevItemInLastYear where ClientId=@ClientId" + nl;
                ...
                else
                {
                    ...
                    sql += "(FirstName,MiddleName,LastName,DOB,Address1,Address2,City,State,ZipCode,SSN,CurrentEmail,CurrentPhone,DrivingLicense,SocialSecCard,ProofOfCard,Status,CreatedBy,CreatedDate,AgentId,AgentStaffId,isPrevItemInLastYear)" + nl;
                    sql += "values(@FirstName,@MiddleName,@LastName,@DOB,@Address1,@Address2,@City,@State,@ZipCode,@SSN,@CurrentEmail,@CurrentPhone,@DrivingLicense,@SocialSecCard,@ProofOfCard,@Status,@CreatedBy,@CreatedDate,@AgentId,@AgentStaffId,@isPrevItemInLastYear);SELECT SCOPE_IDENTITY();";
                    ...
                    if (ClientModel.AgentClientId != 0 && ClientModel.AgentClientId != null)
                    {
                        ...
                        {
                            ClientModel.sSocialSecCard = string.Empty;
                        }
                        ...
                        {
                            ClientModel.sDrivingLicense = string.Empty;
                        }
